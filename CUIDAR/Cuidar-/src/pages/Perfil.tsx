...
import { CONDICIONES_FRECUENTES } from "../utils/opcionesClinicas";
          ...
          >
            ...
            <div className="grid gap-3 mt-4 md:grid-cols-3">
              ...
              >
                ...
                {formData.condicion && !CONDICIONES_FRECUENTES.includes(formData.condicion) && (
                  <option value={formData.condicion}>{formData.condicion}</option>
                )}
                {CONDICIONES_FRECUENTES.map((condicion) => (
